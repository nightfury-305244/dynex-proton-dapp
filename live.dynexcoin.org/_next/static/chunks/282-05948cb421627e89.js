  ...
  [282],
  {
    87282: function (e, t, n) {
      ...
      var o = n(62067),
        ...
        s = n(88089);
      function a(e) {
        return s.fA.get("/network/jobs", { params: e }).then((e) => {
          let { data: t } = e;
          return t.data.map((e) => {
      ...
      function i(e) {
        return s.fA.get("/network/jobs/".concat(e)).then((e) => {
          let { data: t } = e,
      ...
      function d() {
        return s.fA.get("/network/jobs/payment_stats");
      }
      function l() {
        return s.fA.get("/network/jobs/avg_fee");
      }
      function u() {
      ...
      function x() {
        return s.fA.get("/dhip");
      }
      function w(e) {
        return s.fA.get("/network/fee", { params: e }).then((e) => {
          let { data: t } = e;
          return {
            data: t.dtos.map((e) => ({
              id: e.id,
      ...
      function I() {
        return s.fA.get("/network/jobs/stats");
      }
      function C() {
